...
ITEMS = [
    ...
    ("540", "lines", "113", "Underpayment of Estimated Tax Penalty (FTB 5805) -- REGULAR method",
     "addition", "moderate", "FTB 2025 Form 540 Instructions, Line 113; FTB 5805",
     "deferred_new_engine", None,
     "Needs quarter-by-quarter payment timing with a per-diem days-unpaid x semi-annually-"
     "changing interest rate and payment-ordering rules across 4 installment columns -- the "
     "same disqualifying interest-based mechanism already correctly excluded from the late-"
     "filing/late-payment penalty feature. Genuinely multi-period, not a single stated fact. "
     "See the SHORT METHOD row below, which IS built, for the population this general case's "
     "own deferral does NOT block."),
