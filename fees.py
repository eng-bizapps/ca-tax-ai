...
REGIMES = [
    {
        ...
        "groups": [{"tv", "tvs", "television", "televisions", "monitor", "monitors",
                    ...
                    "notebook", "chromebook", "computer", "screen", "display"}],
        "exclude": {"projector"},
        "type": "tiered_screen",
    ...
    },
    {
        ...
        "groups": [{"cannabis", "marijuana", "thc", "dispensary", "cannabinoid"}],
        "exclude": set(),
        "type": "percent",
        "rate": 0.15,
    ...
    },
    {
        ...
        "groups": [{"battery", "batteries"},
                   {"car", "auto", "automotive", "vehicle", "truck", "motorcycle",
                    "marine", "boat", "lead", "leadacid", "acid", "rv", "forklift"}],
        "exclude": {"aa", "aaa", "lithium", "alkaline", "button", "watch", "phone", "laptop"},
        "type": "per_unit",
